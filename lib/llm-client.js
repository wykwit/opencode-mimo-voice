 ...
 * @returns {{ complete: (opts: { system?: string, prompt: string, config?: object, signal?: AbortSignal }) => Promise<{ text: string | null, error?: string }>, synthesize: (opts: { text: string, voice?: string, config?: object, signal?: AbortSignal }) => Promise<{ audioData: string | null, error?: string }> }}
 */
